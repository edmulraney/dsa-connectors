...
abstract contract LiquityResolver is Events, Helpers {
    ...
    function depositAndBorrow(
        ...
        // User's can either send ETH directly or have it collected from an existing deposit in their DSA account
        ...
        // Allow other spells to use the borrowed amount in other spells
        setUint(setId, borrowAmount);
        _eventName = "LogDepositAndBorrow(address,uint,uint,uint,uint)";
        _eventParam = abi.encode(msg.sender, depositAmount, borrowAmount, getId, setId);
    }
   ...
   function withdraw(
    ...
    function borrow(
        ...
        setUint(setId, amount); // TODO: apply fee / get exact amount borrowed (with the fee applied they won't actually get full amount, it will be less)
